...
const About = () => {
  ...
  // Nous n'avons plus besoin de cet état puisque nous utilisons maintenant un lien direct
            ...
            <div className="glass-card p-6 md:p-8 rounded-xl mb-8 shadow-soft hover-3d transform transition-all duration-300">
              <div className="flex justify-between items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="/import { FadeIn, FadeInUp } from './Transitions';
import { User, GraduationCap, Code, Server, FileText } from 'lucide-react';
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from "@/components/ui/collapsible";
import { useState } from 'react';
import { Button } from "@/components/ui/button";
          ...
          <FadeInUp delay={100}>
            <div className="glass-card p-6 md:p-8 rounded-xl mb-8 shadow-soft hover-3d transform transition-all duration-300">
              <div className="flex justify-between items-start">
                ...
                <div className="ml-4">
                  {/* CV Button - Modified to be a direct link */}
                  <a href="../../cv2025.pdf" target="_blank" rel="noopener noreferrer">
                    <Button 
...
export default About;" target="_blank" rel="noopener noreferrer">
                    <Button 
                      className="group relative overflow-hidden glass-button" 
                      variant="secondary"
                    >
